...
HD_PWD='Z:/ELEN_122L/Lab6/lab_6/lab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log l6_TB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source l6_TB.tcl
